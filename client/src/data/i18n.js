...
export const I18N = {
  en: {
    ...
    mol3dLoading:   "Loading 3D structure…",
    mol3dPlay:      "Play rotation",
    mol3dPause:     "Pause rotation",
    no3dModel:      "No 3D model available",
    guestCoachHint: "Combine 2× H + 1× O to land your first catch — water.",
    guestSignUpCta: "Save my progress",
    catchThisToo:   "Catch this too",
    catchTooLocked: "You need to unlock the missing atoms first",
    catchTooReady:  "Recipe loaded — hit Combine!",
  ...
  fr: {
    ...
    rotateHint:     "✋ glissez pour pivoter · pincez pour zoomer",
    mol3dLoading:   "Chargement de la structure 3D…",
    mol3dPlay:      "Lancer la rotation",
    mol3dPause:     "Pauser la rotation",
    no3dModel:      "Modèle 3D indisponible",
    guestCoachHint: "Combinez 2× H + 1× O pour votre première trouvaille — l'eau.",
    guestSignUpCta: "Sauvegarder mes progrès",
    catchThisToo:   "Attrape-la aussi",
    catchTooLocked: "Vous devez d'abord débloquer les atomes manquants",
    catchTooReady:  "Recette chargée — appuyez sur Combiner !",
